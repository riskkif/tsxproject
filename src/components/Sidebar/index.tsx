  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className={'flex items-center gap-2 mt-3'}>
          <img src={LogoIcon} alt="" />
          <h1 className='text-white font-bold'>Dashboard Admin</h1>
        </NavLink>
          ...
          <div>
            ...
            <li>
              ...
              {/* <!-- Menu Item Profile --> */}
                            ...
                            <SidebarLinkGroup
                activeCondition={
                  pathname === '/tabel' || pathname.includes('tabel')
                }
              >
                {(handleClick, open) => {
                  return (
