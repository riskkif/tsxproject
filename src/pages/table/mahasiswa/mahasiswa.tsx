...
const MahasiswaPage = () => {
  ...
  const handleSubmit = async (newUser: Omit<Data, 'id'>) => {
    ...
    try {
      ...
      showToast('error', 'Pendaftaran Akun Tidak Berhasil!');
    }
  };
  ...
  const handleUpdate = async (id: number) => {
    try {
      ...
      formData.append('nim', newUpdateUser.nim);
      formData.append('phone', newUpdateUser.phone);
      formData.append('alamat', newUpdateUser.alamat);
      formData.append('dosen_satu', newUpdateUser.dosen_satu);
      formData.append('dosen_dua', newUpdateUser.dosen_dua);
      ...
      <div className="py-6 px-4 md:px-6 xl:px-7.5">
        ...
        <span className="flex justify-end">
          <button
            ...
            className="btn rounded-md bg-indigo-800 hover:bg-indigo-200 px-4 py-2 text-sm font-medium text-black text-white"
          >
            Tambahkan Mahasiswa
          </button>
        </span>
                ...
                <div className="rounded-md shadow-sm -space-y-px py-4">
                  ...
                  <div className="pt-4">
                    ...
                    <input
                      ...
                      name="dosen_satu"
                      type="text"
                      value={newUpdateUser.dosen_satu}
                      onChange={handleUpdateChange}
                      required
                      className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                      placeholder="dosen_satu"
